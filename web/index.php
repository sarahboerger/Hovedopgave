...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/Enggaarden_Rideskole_slider3.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/Enggaarden_Rideskole_slider2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/Enggaarden_Rideskole_slider4.jpg" alt="Third slide">
    </div>
  </div>
</div>
...
<div class="container-fluid">
        <div class="row frontrow">
           <div class="col-lg-1"></div> 
             <div class="col-lg-5">
            <h3 class="h3nede">Sikker start på ridekarrieren</h3>
            ...
            <div class="col-lg-5">
              <img  class="w-100" src="img/enggaarden_rideskole_forside_billede2.png" alt="Hos Enggaarden rideskole prioriterer vi din grundridning højt inden for akademisk ridekunst">
            </div>
             <div class="col-lg-1"></div> 
        </div>
        ...
        <div class="row frontrow">
          ...
          <div class="col-lg-5 order-sm-1 order-lg-2">
            <h3 class="h3nede">Hesten er en makker, ikke et instrument</h3>
          ...
          <div class="col-lg-5 order-sm-2 order-lg-1">
            <img class="w-100" src="img/enggaarden_rideskole_forside_billede3.png" alt="Hos Enggaarden Skolen for Akademisk Ridekunst vægter vi hestens velfærd højt">
          </div>
        ...
        <div class="row">
           <div class="col-lg-1"></div> 
          <div class="col-lg-5">
            <h3 class="h3nede">Altid et smil på læben</h3>
...
<div class="row" id="video-row">
  <div class="col-lg-1 order-lg-1"></div>
        <div class="col-lg-5 order-sm-1 order-lg-3">
    ...
    <div class="col-lg-5 order-sm-2 order-lg-2">
...
<!-- Begin Mailchimp Signup Form -->
      <div id="mc_embed_signup">
          ...
          <div>
          <h2 class="velkomst-center">Tildmeld dig vores nyhedbrev og hold dig opdateret med det seneste nye fra Enggaarden</h2>
          </div>
