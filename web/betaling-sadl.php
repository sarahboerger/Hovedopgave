...
<div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center">
               ...
               <img src="img/mobilepay-dummy.jpg" alt="mobilepay dummy billede for at illustrere hvordan det kunne se ud">

            </div>
        </div>

            <div id="timer-sadl" class="text-center">0:15</div>
</div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js"
  ...
  <script src="../work/javascript/counterthree.js"></script>
</html>
